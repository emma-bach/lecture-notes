...
\end{definition}
\begin{theorem}
	\ul{\tbf{\emph{Stetigkeitseigenschaften:}}} Sei $(X, \cA, \mu)$ ein Maßraum. Dann gelten für $A_i \subseteq \cA, i \in \bN$ folgende Aussagen:
	\begin{enumerate}
...
\end{definition}
\begin{theorem}
	\ul{\emph{\tbf{Vervollständigung:}}} Sei $(X, \cA, \mu)$ ein Maßraum. Dann ist $\overline{\cA_\mu}$ eine $\sigma$-Algebra und $\overline{\mu}$ ein vollständiges Maß, welches auf $\cA$ mit $\mu$ übereinstimmt.
\end{theorem}
\begin{proof}
	\phantom{}
	\begin{enumerate}
...
\begin{theorem}
	...
	\end{proof}
\end{theorem}
Die Carathéodory-Fortsetzung $\mu$ ist ein vollständiges Maß auf der $\sigma$-Algebra der Messbaren Mengen $\cM(\mu)$, die die durch den Ring $\cR$ generierte $\sigma$-Algebra $\sigma(\cR)$ enthält.
\newpar
Wir wollen als nächstes Zeigen, dass die Carathéodory-Fortsetzung eindeutig ist.
\begin{lemma}
	\theoremname{Maximalitt der Carathéodory-Fortsetzung:} Sei $\mu$ die Carathéodory-Fortsetzung des Prämaßes $\lambda : \cR \to \barR_{\geq 0}$ auf dem Ring $\cR$ über $X$. Sei $\tilde\mu$ ein Maß auf $\sigma(\cR)$ mit $\tilde\mu = \lambda$ auf $\cR$. Dann gilt \begin{align*}
...
\begin{proof}
	...
	\end{align*}
	Durch Bildung des Infimums über alle solchen Überdeckungen liefert die Carathéodory-Fortsetzung.
\end{proof}
