...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
Wir schreiben dementsprechend von nun an $\bN \subseteq \bR$ statt $N \subseteq \bR$.
\begin{theorem}
	Die natürlichen Zahlen sind unter Addition und Multiplikation abgeschlossen.
\end{theorem}
\begin{theorem}
...
\begin{theorem}
	...
	\end{align*}
\end{theorem}
\chapter{Das $n$-dimensionale Lebesquemaß $\lambda^n$}
\begin{lemma}
