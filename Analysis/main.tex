...
\newpar
	...
	\begin{enumerate}
		...
		\begin{align*}
			m(\bigcup_{i}) A_i = \sum_{i} m(A_i) \quad A_i \cap A_j = \infty \quad i \neq j
		\end{align*}
...
\begin{definition}
	Sei $X$ eine Menge und $\cP(X)$ die Potenzmenge. Ein \tbf{Mengensystem} $\cA \subseteq \cP(X)$ heißt \tbf{$\sigma$-Algebra}, falls folgendes gilt:
	\begin{enumerate}
		\item $X \in \cA$
