	...
	\section*{\centering - Körper -}
		...
		\begin{proof}
			\begin{enumerate}
				...
				\begin{enumerate}
					\item Angenommen, $\Irr(\alpha, K)$ ist über $L[X]$ irreduzibel. Dann gilt $\Irr(\alpha, K) = \Irr(\alpha, L)$, also zerfällt $\Irr(\alpha, L)$ über $M$ ebenfalls in Linearfaktoren.
					\item (?)
				\end{enumerate}
				\item $\Irr(\alpha, K)$ zerfällt über $L_1$ und $L_2$ in Linearfaktoren, und da alle Polynomringe über Körpern faktoriell sind, sind diese Zerlegungen bis auf Reihenfolge eindeutig. Somit müssen alle dieser Linearfaktoren bereits in $L_1 \cap L_2$ liegen, also zerfällt das Polynom auch über $L_1 \cap L_2$ in Linearfaktoren.
			\end{enumerate}
		\end{proof}
