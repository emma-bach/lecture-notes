...
\begin{definition}
	Sei $L \supset K$ eine Körpererweiterung. So bildet die Menge der bijektiven Körperhomomorphismen $L \to L$, welche $K$ konstant halten, eine Gruppe, welche wir die Galoisgruppe $\tn{Gal}(L/K)$ nennen.
\end{definition}
\begin{example}
	$\tn{Gal}(\bC/\bR)$ besteht aus der Identität und der komplexen Konjugation.
\end{example}
\begin{theorem}
