...
\end{theorem}
\section{Charaktersummen II}
\begin{definition}
	Definiere die \tbf{Jacobisumme} zweier Charaktere $\chi, \theta$ als:
	\begin{align*}
...
\end{lemma}
\begin{theorem}
	Seien $\chi, \theta \neq \epsilon$ Charaktere, sodass $\chi \cdot \theta \neq \epsilon$. Dann gilt:
	\begin{align*}
...
(...)
\begin{application}
	Wir wollen für ein festes $n$ und $p \equiv 1 \mod n$ die Anzahl an Lösungen der Gleichung
	\begin{align*}
		X^n + Y^n = 1
	\end{align*}
	in $\bF_p$ finden. Es wird sich hreausstellen, dass es "in etwa $p$" gibt. Es gilt:
	\begin{align*}
		N(X^n + Y^n = 1) &= \sum_{a + b = 1} N(x^n = a)N(y^n = b)\\
						 &= \sum_{a + b = 1} \sum_{\chi^n = \epsilon} \chi(a) \sum_{\theta^n = \epsilon} \theta(b)\\
						 &= \sum_{\chi^n = \epsilon, \theta^n = \epsilon} J(\chi,\theta)\\
						 &= p - \sum_{\chi^n = \epsilon, \chi \neq \epsilon} \chi(-1) + \sum_{{\chi \cdot \theta \neq \epsilon,}{\chi^n = \theta^n = \epsilon}} J(\chi,\theta)\\
						 &= p + 1 - N(x^n = -1) + \sum_{{\chi \cdot \theta \neq \epsilon,}{\chi^n = \theta^n = \epsilon}} J(\chi,\theta)
	\end{align*}
	\begin{align*}
		\implies N(x^n + y^n = 1) - p - 1 + N(x^n = -1) &= \sum_{{\chi \cdot \theta \neq \epsilon,}{\chi^n = \theta^n = \epsilon}} J(\chi,\theta)\\
		\implies \abs{N(x^n + y^n = 1) - p - 1 + N(x^n = -1)} &\leq \sum_{{\chi \cdot \theta \neq \epsilon,}{\chi^n = \theta^n = \epsilon}} \abs{J(\chi,\theta)}\\
		&\leq \sqrt{p}(n^2-n)\\
