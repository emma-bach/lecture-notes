...
\begin{document}
	...
	\begin{enumerate}
		...
		Nun sind die Bilder $\phi(h)$ und $\phi(K)$ dieser Figuren unter einer Möbiustransformation $\phi$ der eindeutige auf $\hat g$ senkrechte verallgemeinerte Kreis durch $\phi(m)$ und $\phi(\infty)$ und der eindeutige auf $\hat g$ senkrechte Kreis durch $\phi(s_1)$ und $\phi(s_2)$ - Diese Kreise sind eindeutig gemäß 7.2. Wir können nun $\phi(x)$ zurückgewinnen als denjenigen Schnittpunkt von $\phi(h)$ und $\phi(K)$, der auf der gleichen Seite von $\hat g$ liegt wie $x$.
		\item[7.1 - \tbf{2}]
