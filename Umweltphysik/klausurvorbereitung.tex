...
Insgesamt folgt auf der Nordhalbkugel $(\sin(\phi) > 0)$: \vspace{-5pt}
\begin{itemize}
	\item Bewegung nach Norden führt zu Beschleunigung nach Osten \vspace{-5pt}
	\item Bewegung nach Süden führt zu Beschleunigung nach Westen \vspace{-5pt}
	\item Bewegung nach Osten führt zu Beschleunigung nach Süden \vspace{-5pt}
	\item Bewegung nach Westen führt zu Beschleunigung nach Norden \vspace{-5pt}
\end{itemize}
In der Südhemisphäre gilt $(\sin(\phi) < 0)$, also wird die Bewegung umgekehrt.
\end{document}